...
- **EventRepository.kt**: Event CRUD plus event-worker assignment operations and total cost lookups.
...
- Use shared utilities (like `PaymentCalculator`) for financial math in higher layers to keep logic consistent.
